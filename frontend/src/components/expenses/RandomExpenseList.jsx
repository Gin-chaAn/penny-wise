...
export default function RandomExpenseList({ expenses, onEdit, onDelete, onAdd }) {
  if (expenses.length === 0) {
    return (
      <EmptyState
        title="NO RANDOM EXPENSES"
        description="Your spontaneous spending will appear here."
    ...
    <div className="space-y-3">
      ...
      {expenses.map((e) => (
        <Card key={e.id} className="flex items-center justify-between !py-3">
          <div>
            <p className="text-ivory font-medium">{e.description}</p>
